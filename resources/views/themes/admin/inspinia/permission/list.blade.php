...
@section('content')
@inject('presenter', 'App\Repositories\Presenters\Admin\System\PermissionPresenter')
<div class="row wrapper border-bottom white-bg page-heading">
  ...
  <div class="col-lg-2">
    <div class="title-action">
      ...
      <a href="{{route('permission.create')}}" class="btn btn-info"><i class="fa fa-plus"></i> 创建权限</a>
      @endif
    </div>
  </div>
</div>
