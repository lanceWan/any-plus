        ...
        <div class="ibox-content">
          ...
          <form method="post" action="{{route('permission.store')}}" class="form-horizontal">
            ...
            <div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="slug" value="{{old('slug')}}" placeholder="权限"> 
                @if ($errors->has('slug'))
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="description" value="{{old('description')}}" placeholder="描述">
              </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
