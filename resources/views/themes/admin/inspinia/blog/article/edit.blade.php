  ...
  <div class="row">
    <form method="post" action="{{route('article.update', [encodeId($article->id)])}}" class="form-horizontal" enctype="multipart/form-data">
      ...
      <div class="col-lg-4 col-md-12">
        ...
        <div class="ibox">
          <div class="ibox-title">
            <h5><i class="fa fa-list"></i> 文章Banner</h5>
          </div>
          <div class="ibox-content">
                ...
                <div class="col-sm-12">
                  <div class="fileinput fileinput-new" data-provides="fileinput">
                    <div class="fileinput-new thumbnail">
                      <img src="{{ $article->banner ? $article->banner : asset(getThemeAssets('img/no-image.png')) }}">
                    </div>
                  ...
                  <div class="hr-line-dashed"></div>
                  <input type="text" class="form-control" name="edit_banner" value="{{old('edit_banner')}}" placeholder="固定网址图片填写，上传组件将失效">
                </div>
              </div>
          </div>
        </div>
