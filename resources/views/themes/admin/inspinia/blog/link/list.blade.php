...
@section('content')
@inject('presenter', 'App\Repositories\Presenters\Admin\Blog\LinkPresenter')
<div class="row wrapper border-bottom white-bg page-heading">
  ...
  <div class="col-lg-2">
    <div class="title-action">
      @if(haspermission('linkcontroller.create'))
      <a href="{{route('link.create')}}" class="btn btn-info"><i class="fa fa-plus"></i> 创建友链</a>
      @endif
    </div>
  </div>
</div>
    ...
    <div class="col-lg-12">
      <div class="ibox">
        ...
        <div class="ibox-content">
          ...
          <div class="row">
            @if($links->total())
            <div class="col-sm-4 m-t-md text-left">显示第 {{($links->currentPage() - 1) * $links->perPage() }} 至 {{ $links->total() > $links->perPage() ?  $links->currentPage() * $links->perPage() : $links->total() }} 项结果，共 {{$links->total()}} 项</div>
            @endif
