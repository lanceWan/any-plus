  ...
  <div class="ibox-content">
    <form method="post" action="{{route('menu.store')}}" class="form-horizontal" id="createForm">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" placeholder="菜单图标" value="" name="icon">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <select data-placeholder="菜单权限" data-live-search="true" class="selectpicker form-control" name="slug">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" placeholder="菜单连接" value="" name="url">
        </div>
      </div>
      <div class="hr-line-dashed"></div>
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" placeholder="高亮地址" value="" name="active">
        </div>
      </div>
      <div class="hr-line-dashed"></div>
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" placeholder="菜单描述" value="" name="description">
        </div>
      </div>
      <div class="hr-line-dashed"></div>
      <div class="form-group">
